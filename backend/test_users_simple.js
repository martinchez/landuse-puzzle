...
async function testUsersEndpointSimple() {
  try {
    console.log('🧪 Testing /api/admin/users endpoint (simple)...\n');
    
    // Test without sort parameters first
    const response = await httpRequest('http://localhost:3001/api/admin/users?page=1&limit=10', {
      method: 'GET',
      headers: {
